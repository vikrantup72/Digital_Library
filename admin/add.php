...
<div class="box box-success">
	...
	<div class="box-body">
		<form method="post" id="addForm" enctype="multipart/form-data" name="addForm" class="form-horizontal">
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">Uploaded by:</label>
						<div class="col-sm-8">
							<input type="text" id="bpublish" name="bpublish" class="form-control" placeholder="Enter the Staff Name" required="required">
							<div id="err4"></div>
						</div>
					</div>
					...
					<div class="form-group">
                      <label class="col-sm-3 control-label">Number of Pages:</label>
						<div class="col-sm-2">
							<input type="number" id="bpages" name="bpages" class="form-control" placeholder="No of pages in Book" required="required">
							<div id="err6"></div>
						</div>
					</div>
