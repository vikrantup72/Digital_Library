				...
				while($result = $stmt->fetch(PDO::FETCH_ASSOC)){
					...
					echo "
									...
									echo "
										...
										<td>$BK_GENRE</td>
										<td>$BK_LANGUAGE</td>
										<td align='center'><button id='modals' data-toggle='modal' data-target='#book' class='btn btn-default' value='$BK_ID' data-balloon='View Book Details' data-balloon-pos='up'><i class='fa fa-fw fa-book'></i></button></td>
									  </tr>
									";
				}
